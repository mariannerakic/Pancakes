# Pancakes: Stochastic In-Context Learning for Medical Image Segmentation


Official implementation of: _Pancakes: Stochastic In-Context Learning for Medical Image Segmentation_.  
